...
const apiEnvSchema = z.object({
  ...
  AI_PROVIDER: z.string().min(1).default('bedrock'),
  ...
  BEDROCK_MAX_OUTPUT_TOKENS: z.coerce.number().int().positive().default(1024),
  MAX_CHAT_REQUESTS_PER_MINUTE: z.coerce.number().int().positive().default(10),
